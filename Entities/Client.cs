...
namespace Entities
{
    ...
    public class Client
    {
        ...
        /// </summary>
        public virtual Address Address { get; set; } // Addresses.FK_ClientAddress
        /// <summary>
        /// Child Cards where [Cards].[ClientID] point to this entity (FK_ClientCard)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Card> Cards { get; set; } // Cards.FK_ClientCard
