...
namespace Entities
{
    ...
    public class Card
    {
        ...
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Operation> Operations_In { get; set; } // Operations.FK_InCard
        /// <summary>
        /// Child Operations where [Operations].[OutID] point to this entity (FK_OutCard)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Operation> Operations_Out { get; set; } // Operations.FK_OutCard
        ...
        /// </summary>
        public virtual Client Client { get; set; } // FK_ClientCard
